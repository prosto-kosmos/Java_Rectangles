...
public class Window extends Canvas{
	...
	private void render() {
		...
		// () - это метод run()
		// render() - это то, что будет находиться в методе run()
		// равносильно передачи new Runnable()
		// После того, как выполятся все события, выполнится run()
		// То есть отрисовка всех событий после их выполнения
